...
SabisuRails.setup do |config|
  ...
  config.base_api_uri = 'api.rails_twitter_api.dev'
  ...
  config.api_headers = { "Accept" => "application/vnd.railstwitter.v1" }
  #
  # config.api_headers = {}
  ...
  config.resources = [ :tweets ]

  # Default resource
  config.default_resource = :tweets
